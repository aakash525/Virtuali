...
public class PatientNotesList extends AppCompatActivity {
...
//                    finish();
                    Intent i1 = new Intent(PatientNotesList.this, NotesActivity.class);
//                    i1.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    startActivity(i1);
                    return true;
                case R.id.navigation_list_patient:
                    Intent i2 = new Intent(PatientNotesList.this, PatientNotesList.class);
                    startActivity(i2);
//                    mTextMessage.setText(R.string.title_list);
                    return true;

                case R.id.navigation_list_doctor:
                    Intent i3 = new Intent(PatientNotesList.this, DoctorNotesList.class);
                    startActivity(i3);
//                    mTextMessage.setText(R.string.title_list);
                    return true;
            }
    ...
    private void fetchRecordings() {
        ...
        String path = root.getAbsolutePath() + "/Virtuali/PatientVoiceNotes";
        ...
        if( files!=null ){
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                String recordingUri = root.getAbsolutePath() + "/Virtuali/PatientVoiceNotes/" + fileName;
