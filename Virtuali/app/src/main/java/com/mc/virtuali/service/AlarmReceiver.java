package com.mc.virtuali.service;
...
import com.mc.virtuali.ui.AlarmLandingPageActivity;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static void setReminderAlarm(Context context, Alarm alarm) {
        ...
        alarm.time=nextAlarmTime.getTimeInMillis();
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            am.set(AlarmManager.RTC_WAKEUP, alarm.time, pIntent);
        } else {
            am.setExact(AlarmManager.RTC_WAKEUP, alarm.time, pIntent);
        }
    ...
    private static Calendar getTimeForNextAlarm(Alarm alarm) {
        ...
        final SparseBooleanArray daysArray = alarm.allDays;
